        ...
        <div className="profilecard">
          <div className="card-container">
            <div className="profile-item">
              ...
              <Tooltip title="SUPPRIMER VOTRE COMPTE" TransitionComponent={Zoom}>
                <button className="btndelete" type="button" data-bs-toggle="tooltip" data-bs-placement="right" title="supprimer votre compte" href="#" onClick={this.handleDelete}>
                <DeleteOutlineIcon className="profile_icons" fontSize="large" aria-label="delete"/>
                </button>
              </Tooltip>
              <Tooltip title="MODIFIER VOTRE COMPTE" TransitionComponent={Zoom}>
                <button className="btnedit" type="button" data-bs-toggle="tooltip" title="modifier votre profil" >
                <EditIcon fontSize="large" />
                </button>
              </Tooltip>
              <Tooltip title="CONFIRMER LA MODIFICATION" TransitionComponent={Zoom}>
                <button className="btncheck" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="confirmer modification" >
